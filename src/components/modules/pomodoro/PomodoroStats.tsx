    ...
    return (
        <div className="grid grid-cols-3 gap-4">
            {statItems.map((item, index) => (
                <div
                    key={index}
                    className="bg-card-background border border-border p-4 rounded-2xl flex flex-col items-center text-center space-y-2 hover:border-primary/30 transition-colors"
                >
