                                    ...
                                    <div className="flex items-center gap-2 text-muted flex-wrap">
                                        {event.date ? (
                                            <div className="flex items-center gap-1 shrink-0">
                                                ...
                                                <span className="text-xs font-mono shrink-0">{formatDate(event.date)}</span>
                                            </div>
                                        ) : null}
                                        <div className="flex items-center gap-1 shrink-0">
                                            <Clock className="w-3 h-3 text-muted/70 shrink-0" />
                                            <span className="text-xs font-mono shrink-0">{event.time}</span>
                                        </div>
                                    </div>
